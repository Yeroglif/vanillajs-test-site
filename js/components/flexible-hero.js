...
export default (hostComponent) => {
    ...
    const header = hostComponent.getAttribute('data-header') || '';
    const text = hostComponent.getAttribute('data-text') || '';
    ...
    `;
    if(buttonText===''){
      hostComponent.querySelectorAll('a').forEach(a => {a.style.display='none';});
    }
  };